...
import { ArrowRight, Settings, Zap, Shield, Database, Cloud } from "lucide-react";
...
const features = [
  { icon: Settings, title: "Custom Solutions", description: "Tailored to your unique business needs" },
  { icon: Database, title: "Scalable", description: "Grows with your business" },
  { icon: Cloud, title: "Cloud-Ready", description: "Modern cloud architecture" },
      ...
      <SectionWrapper className="py-16 section-glow">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Custom <span className="gradient-text">Software Development</span>
            </motion.h1>
        ...
        <div className="container mx-auto px-4 lg:px-8 text-center">
          <FadeInOnView>
            <GlassCard className="py-12">
              <h2 className="font-display text-3xl font-bold mb-4">Need Custom Software?</h2>
