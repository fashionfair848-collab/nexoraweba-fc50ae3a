...
const guarantees = [
  { icon: Shield, title: "Money-Back Guarantee", desc: "Not satisfied? Full refund within 30 days" },
  { icon: Clock, title: "On-Time Delivery", desc: "We deliver when we promise, every time" },
  { icon: TrendingUp, title: "Performance Guaranteed", desc: "Your site will load in under 3 seconds" },
  { icon: Headphones, title: "Lifetime Support", desc: "We're here whenever you need us" },
];

const faqs = [
  { q: "How long does a typical project take?", a: "Most projects take 2-8 weeks depending on complexity. We'll give you an exact timeline during our consultation." },
  { q: "What if I need changes after launch?", a: "All packages include free support period. After that, we offer affordable maintenance plans." },
  { q: "Do you work with international clients?", a: "Absolutely! We've worked with clients from 15+ countries and handle timezone differences seamlessly." },
  { q: "What makes NEXORA different from other agencies?", a: "We focus on results, not just pretty designs. Every decision is made to increase your conversions and ROI." },
];
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <FadeInOnView>
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">Find the perfect package for your business stage</p>
            </div>
          </FadeInOnView>
          ...
          <FadeInOnView>
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Join businesses from 15+ countries who trust NEXORA with their digital success
              </p>
            </div>
          </FadeInOnView>
        </div>
          ...
          <FadeInOnView>
            <GlassCard className="text-center py-16 px-8">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
                Book a free consultation and let's discuss how we can bring your vision to life. No pressure, no commitment—just a friendly chat about your goals.
              </p>
